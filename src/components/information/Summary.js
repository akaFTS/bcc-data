    ...
    return (
      <ContentBox title="Introdução" color="orange">
        <div className="fw3 lh-copy gray f6">
          ...
          <p className="mt2">
            O Bacharelado em Ciência da Computação do IME-USP foi fundado em
            1972. Em seus mais de 40 anos de história e centenas de bacharéis
            formados, várias mudanças estruturais foram ocorrendo de modo a
            acomodar o crescimento do curso e a evolução da área. Este site foi
            criado para ilustrar de forma gráfica e simples um pouco de como se
            deu esta evolução.
          </p>
          <p className="mb2">
          ...
          <p className="mb2">
            ...
            <span className="i"> src/data/</span> do projeto, enquanto as
            imagens estão na pasta <span className="i">public/</span>. Os
          ...
          <p className="mb2">
            ...
            permitem um fácil entendimento da estrutura do projeto.
            Contribuições são bem-vindas e ainda há bastante coisa interessante
            que pode ser adicionada, como fotos antigas ou depoimento de
            ex-alunos. Além disso, a pesquisa dos ex-alunos no Linkedin pode ser
            aprimorada ou refeita.
          </p>
          <p className="mb2">
