    ...
    <ContentBox title="Dados" color="orange">
      <div className="fw3 lh-copy gray f6">
        ...
        <ul className="gray fw3">
          ...
          <li className="mb3 lh-title">
            <span>
              <span className="b">Grade:</span> Informações da grade curricular
              do BCC, discretizada para os anos em que houveram as maiores
              mudanças. Em alguns momentos essas mudanças se deram ao longo de
              dois ou três anos, mas foram &quot;compiladas&quot; para um ano só
              para facilitar a visualização. Os catálogos de graduação foram
              usados de novo.
            </span>
          </li>
          <li className="mb3 lh-title">
          ...
          <li className="mb3 lh-title">
            <span>
              ...
              tamanho pequeno da pesquisa implica em uma imprecisão considerável
              nos resultados, mas pelo seu caráter manual era o máximo que foi
              possível fazer.
            </span>
          </li>
        </ul>
